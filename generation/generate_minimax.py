"""
Generate audio files using MiniMax
...
usage: python generate_minimax.py -i "real1.tsv" -o "output" -g "female" -t "fake1.tsv" -v "Arabic_CalmWoman"
"""
import os
import pandas as pd
...
def generate_audio(text, voice, audio_file, output_folder):
    ...
    response = requests.request("POST", url, stream=False, headers=headers, data=payload)
...
def create_generated_audio(batch, voice, output_dir):
    ...
    batch['tts'] = "speech-2.5-hd-preview"
